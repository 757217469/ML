...
# 计算roc值
lr_fpr, lr_tpr, lr_thresholds = metrics.roc_curve(y_test_hot.ravel(), lr_y_score.ravel())
# threshold 阈值
# 计算auc的值
lr_auc = metrics.auc(lr_fpr, lr_tpr)
# 7.模型预测
lr_y_predict = lr.predict(X_test)
print('Logistic算法R2值: ', lr.score(X_train, Y_train))
...
# 计算roc的值
knn_fpr, knn_tpr, knn_thresholds = metrics.roc_curve(y_test_hot.ravel(), knn_y_score.ravel())
# 计算auc的值
