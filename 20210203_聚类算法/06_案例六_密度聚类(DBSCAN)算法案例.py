...
data1, y1 = ds.make_blobs(N, n_features=2, centers=centers, cluster_std=(1, .75, .5, .25), random_state=0)
data1 = StandardScaler().fit_transform(data1)
params1 = ((.15, 5), (.2, 10), (.2, 15), (.3, 5), (.3, 10), (.3, 15))
...
params2 = ((.5, 3), (.5, 5), (.5, 10), (1., 3), (1., 10), (1., 20))
...
for i, (X, y, params) in enumerate(datasets):
    ...
    for j, param in enumerate(params):
        ...
        # min_samples  远离中所说的M, 控制哪个是核心点, 值越小, 越可以容忍噪声点, 越大,就更容易把有效点划分成噪声点
        model.fit(X)
        y_hat = model.labels_
