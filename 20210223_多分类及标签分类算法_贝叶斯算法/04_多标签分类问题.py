...
def plot_subfigure(X, Y, subplot, title):
    ...
    plt.scatter(X[zero_class, 0], X[zero_class, 1], s=160, edgecolors='b', facecolors='none', lw=2, label='Class 1')
    plt.scatter(X[one_class, 0], X[one_class, 1], s=80, edgecolors='orange', facecolors='none', lw=2, label='Class 2')
...
X, Y = make_multilabel_classification(n_classes=2, n_labels=1,
                                      ...
                                      random_state=1)
plot_subfigure(X, Y, 1, 'With unlabeld samples + CCA')
