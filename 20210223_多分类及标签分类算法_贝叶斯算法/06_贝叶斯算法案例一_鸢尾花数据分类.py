...
iris_class = 'Iris_setosa', 'Iris-versicolor', 'Iris-virginica'
features = [2, 3]

data = './datas/iris.data'
...
# 数据分割,形成模型训练数据和测试数据
x_train1, x_test1, y_train1, y_test1 = train_test_split(x, y, train_size=.8, random_state=14)
