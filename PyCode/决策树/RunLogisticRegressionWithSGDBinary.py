...
def trainEvaluateModel(trainData, validationData, numIterations, stepSize, miniBatchFraction):
    ...
    print('训练评估: 使用参数numIterations=' + str(numIterations) + ', stepSize=' + str(stepSize) + ', miniBatchFraction=' + str(
...
if __name__ == '__main__':
    ...
    testData.persist()
    print('==========训练评估阶段=============')
    AUC, duration, numIterationsParm, stepSizeParm, miniBatchFractionParm, model = trainEvaluateModel(trainData, validationData,
                                                                                       15, 10, .5)
